...
PARAM$train$training     <- c( 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906 )
...
PARAM$train$semilla  <- 139133  # cambiar por su propia semilla  !!!
